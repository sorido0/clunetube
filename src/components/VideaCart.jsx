...
export const VideaCart = ({
    ...
    // const videoReproduciones = reproducciones;
    //console.log( id )
    
    return (
        <Link to={`videoplayer`} key={key} 
        onClick={() => {localStorage.setItem('video', JSON.stringify({title, channel, image, id, key, time, virificado, fecha, reproducciones, likes, descricion}))}
                }
        >
